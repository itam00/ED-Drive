...
public interface PositionList<E> extends Iterable<E>
{
	 ...
	 * @param rb Posicion en cuya posicion anterior se insertara el elemento pasado por parametro. 
	 * @param element Elemento a insertar antes de la posicion pasada como parametro.
	 * @throws InvalidPositionException si la posicion es invalida o la lista esta vacia.
	 */
	public void addBefore(Position<E> rb, E element) throws InvalidPositionException;
